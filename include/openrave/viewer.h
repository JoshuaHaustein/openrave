...
protected:
    ...
    virtual GraphHandlePtr drawbox(const RaveVector<float>& vpos, const RaveVector<float>& vextents, const RaveVector<float>& vcolor, const Transform& tf) OPENRAVE_DUMMY_IMPLEMENTATION;
