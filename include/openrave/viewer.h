...
protected:
    ...
    virtual GraphHandlePtr drawbox(const RaveVector<float>& vpos, const RaveVector<float>& vextents, const RaveVector<float>& vcolor) OPENRAVE_DUMMY_IMPLEMENTATION;
