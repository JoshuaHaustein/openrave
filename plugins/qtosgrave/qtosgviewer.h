...
public:
    ...
    virtual void _DrawBox(OSGSwitchPtr handle, const RaveVector<float>& vpos, const RaveVector<float>& vextents, const RaveVector<float>& vcolor, bool bUsingTransparency);
