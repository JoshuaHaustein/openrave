...
public:
    ...
    virtual GraphHandlePtr drawbox(const RaveVector<float>& vpos, const RaveVector<float>& vextents, const RaveVector<float>& vcolor, const Transform& tf);
...
public:
    ...
    virtual void _DrawBox(OSGSwitchPtr handle, const RaveVector<float>& vpos, const RaveVector<float>& vextents, const RaveVector<float>& vcolor, const Transform& tf, bool bUsingTransparency);
