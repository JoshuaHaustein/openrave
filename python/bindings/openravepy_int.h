...
typedef boost::shared_ptr<PyContinuousCollisionReport> PyContinuousCollisionReportPtr;
typedef boost::shared_ptr<PyContinuousCollisionReport const> PyContinuousCollisionReportConstPtr;
...
ContinuousCollisionReportPtr GetContinuousCollisionReport(object);
ContinuousCollisionReportPtr GetContinuousCollisionReport(PyContinuousCollisionReportPtr);
PyContinuousCollisionReportPtr toPyContinuousCollisionReport(ContinuousCollisionReportPtr, PyEnvironmentBasePtr);
void UpdateContinuousCollisionReport(PyContinuousCollisionReportPtr, PyEnvironmentBasePtr);
void UpdateContinuousCollisionReport(object, PyEnvironmentBasePtr);
